...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pomelo/node_modules/pomelo/lib/pomelo.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pomelo/node_modules/pomelo/lib/pomelo.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pomelo/node_modules/pomelo/lib/</a> &#187; pomelo.js</div>
</div>
<div class="body">
...
Pomelo.createApp = function (opts) {
  var app = application;
  app.init(opts);
<span class="cstat-no" title="statement not covered" >  self.app = app;</span>
...
<span class="cstat-no" title="statement not covered" >    return self.app;</span>
  }
});
&nbsp;
/**
...
fs.readdirSync(__dirname + '/components').forEach(function (filename) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!/\.js$/.test(filename)) {

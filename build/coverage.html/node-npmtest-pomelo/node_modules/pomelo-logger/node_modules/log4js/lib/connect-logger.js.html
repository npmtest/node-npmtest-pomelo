...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pomelo/node_modules/pomelo-logger/node_modules/log4js/lib/connect-logger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pomelo/node_modules/pomelo-logger/node_modules/log4js/lib/connect-logger.js</span></h1>
    <h2>
        
        Statements: <span class="metric">9.38% <small>(6 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pomelo/node_modules/pomelo-logger/node_modules/log4js/lib/</a> &#187; connect-logger.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >						var line = fmt(req, res, <span class="fstat-no" title="function not covered" >function(str){</span> <span class="cstat-no" title="statement not covered" >return format(str, req, res); </span>});</span>
...
<span class="cstat-no" title="statement not covered" >						thislogger.log(level, format(fmt, req, res));</span>
					}
				}
			};
		}
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function format(str, req, res) {</span>
<span class="cstat-no" title="statement not covered" >	return str</span>
    ...
    .replace(/:req\[([^\]]+)\]/g, <span class="fstat-no" title="function not covered" >function(_, field){</span> <span class="cstat-no" title="statement not covered" >return req.headers[field.toLowerCase()]; </span>})
    .replace(/:res\[([^\]]+)\]/g, <span class="fstat-no" title="function not covered" >function(_, field){</span>
